/* $Id: ldspatt.cc 864 2006-09-13 13:21:10Z gnuel $ */
/*
...
int main (int argc, char **argv) {
  ...
  ldspattparameters params;
  ldspattparameterparser parser;
  ...
  if ((M->get_model()!=NULL || M->get_order()<=0) &&  M->get_stationary()!=NULL) {
    S= new ldstat(params,alpha,seq,occ,*M,I);
  } else {
