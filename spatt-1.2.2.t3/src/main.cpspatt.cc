/* $Id: cpspatt.cc 705 2006-03-09 07:49:19Z gnuel $ */
/*
...
/*********************************************************************/   
/*  								     */
/*  cpspatt main program                                              */
/*  								     */
/*  Author: Grégory Nuel					     */
/*  								     */
/*********************************************************************/

#include "cpspattparameters.h"
#include "cpspattparameterparser.h"
...
int main (int argc, char **argv) {
  ...
  cpspattparameters params;
  cpspattparameterparser parser;
  ...
  if ((M->get_model()!=NULL || M->get_order()<=0) &&  M->get_stationary()!=NULL) {
    S= new cpstat(params,alpha,seq,occ,*M,I);
  } else {
    S = new spatt::stat(params,alpha,seq,occ,*M,I);
  }
