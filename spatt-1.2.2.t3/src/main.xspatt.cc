/* $Id: xspatt.cc 864 2006-09-13 13:21:10Z gnuel $ */
/*
...
/*********************************************************************/   
/*  								     */
/*  newxspatt main program                                              */
/*  								     */
/*  Author: Grégory Nuel					     */
/*  								     */
/*********************************************************************/

#include "xspattparameters.h"
#include "xspattparameterparser.h"
...
int main (int argc, char **argv) {
  ...
  xspattparameters params;
  xspattparameterparser parser;
  ...
  if ((M->get_model()!=NULL || M->get_order()<=0) &&  M->get_stationary()!=NULL) {
    S= new newxstat(params,alpha,seq,occ,*M,I);
  } else {
